...
class DD3DTargetPreparer:
    ...
    def __call__(
        self, locations, gt_instances, feature_shapes, gt_weights, labeled_weights
    ):
        ...
        weights = cat([x.reshape(-1) for x in training_targets["weights"]])
    ...
    def compute_targets_for_locations(
        self, locations, targets, size_ranges, num_loc_list, weights, labeled_weights
    ):
        labels = []
        box2d_reg = []
        out_weights = []
        ...
        for im_i in range(len(targets)):
            ...
            weights_per_im = weights[im_i]
            labeled_weights_per_im = labeled_weights[im_i]
            ...
            if bboxes.numel() == 0:
                ...
                out_weights.append(labels_per_im.new_zeros(locations.size(0)))
            ...
            weights_per_im[locations_to_min_area == INF] = labeled_weights_per_im

            labels.append(labels_per_im)
            out_weights.append(weights_per_im)
