...
def get_evaluator(cfg, dataset_name, evaluator_name, output_dir):
    ...
    ), f"Invalid evaluator name: {evaluator_name}."
    ...
    if evaluator_name == "coco_evaluator":
        ...
        return COCOEvaluator(
            dataset_name, tuple(tasks), distributed=distributed, output_dir=output_dir
        )
        ...
        return NuscenesEvaluator(
            nusc_root=nusc_root, dataset_name=dataset_name, output_dir=output_dir
        )
