...
class D2PredictionVisualizer:
    ...
    def __init__(self, cfg, dataset_name, inference_output_dir):
        ...
        self._d2_viz_color_mode = D2_COLORMODE_MAPPING[
            cfg.VIS.D2.PREDICTIONS.COLOR_MODE
        ]
        ...
        if "bbox2d" in tasks:
            with open(
                os.path.join(inference_output_dir, DETECTION_RESULT_FILE), "r"
            ) as f:
    ...
    def visualize(self, x):
        ...
        if "annotations" in x:
            ...
            viz = Visualizer(
                ...
                self._metadata,
                scale=self._scale,
                instance_mode=self._d2_viz_color_mode,
            )
...
class D2DataloaderVisualizer:
    ...
    def visualize(self, x):
        ...
        viz_image = draw_gt_instances_d2(
            gt_instances, img, self._metadata, self._scale, self._d2_viz_color_mode
        )
        viz_images["viz_gt_instances_d2"] = viz_image
